...
export class AboutComponent implements OnInit {
  ...
  skillList: any[] = [
    { name: "HTML", value:90, icon:'H5' },
    { name: "Javascript", value:78, icon:'JS' },
    { name: "CSS", value:80, icon:'C3' },
    { name: "Typestript", value:80, icon:'TS' },
    { name: "SASS", value:76, icon:'SA' },
    { name: "Angular", value:80, icon:'NG' },
    { name: "JSON", value:54, icon:'JN' },
    { name: "Angular CLI", value:84, icon:'AC' },
    { name: "Bootstrap", value:67, icon:'BT' },
    { name: "Git", value:65, icon:'GT' },
    { name: "Tailwind CSS", value:67, icon:'TC' },
    { name: "Github", value:45, icon:'GH' },
    { name: "Angular Material", value:87, icon:'AM' },
    { name: "Node.js", value:82, icon:'ND' },
    { name: "Ag-Grid", value:54, icon:'AG' },
    { name: "Expres.js", value:65, icon:'EX' },
    { name: "PrimNG", value:32, icon:'PG' },
    { name: "Nest.js", value:74, icon:'NS' },
    { name: "ChartJs", value:76, icon:'CH' },
    { name: "PhpmyAdmin", value:59, icon:'PM' },
    { name: "Mchart", value:67, icon:'MC' },
    { name: "MySQL", value:87, icon:'MQ' },
    { name: "Highcharts", value:56, icon:'HC' },
    { name: "Sequelizejs", value:80, icon:'SQ' },
    { name: "Gitlab", value:87, icon:'GL' },
    { name: "Sequelize cli", value:76, icon:'SL' },
    { name: "Bitbucket", value:45, icon:'BK' },
    { name: "TypeORM", value:34, icon:'TO' },
    { name: "Slack", value:87, icon:'SK' },
    { name: "MongoDB", value:56, icon:'MD' }
  ];
