...
export class WriterDashboardComponent implements OnInit {
  ...
  sideBarArr: any[] = [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-house-door", title: "Dashboard", route:"writer/dash/analytical",
      subTitleArr: [
    ...
    {  
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-grid", title: "App", route:"writer/app/mail",
      subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-folder", title: "File Manager", route:"writer/file/dashboard",
      subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-globe", title: "Blog", route:"writer/blog/dashboard",
      subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-gem", title: "UI Elements", route:"writer/uielenents/dashboard",
      subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-puzzle", title: "Widgets", route:"writer/widgets/dashboard", subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-file-lock2", title: "Authentication", route:"writer/authentication/dashboard", subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-files", title: "Pages",route:"writer/pages/dashboard", subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-pencil", title: "Forms", route:"writer/forms/dashboard",subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-table", title: "Tables", route:"writer/tables/dashboard",subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-pie-chart", title: "Charts", route:"writer/charts/dashboard",subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-map", title: "Maps",route:"writer/maps/dashboard", subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-grid", title: "Drag And Drop", route:"writer/draganddrop/dashboard",subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-tags", title: "Menu Level 1", route:"writer/mlevel1/dashboard",subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-tags", title: "Menu Level 2", route:"writer/mlevel2/dashboard",subTitleArr: [
    ...
    {
      id: Math.floor(Math.random() * 1000 + 100), color: "#49c5b6", icon: "bi bi-tags", title: "More", route:"writer/more/dashboard", subTitleArr: [
